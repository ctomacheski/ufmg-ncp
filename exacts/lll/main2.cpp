...
int main(int argc, char *argv[]) {
  ...
  std::vector<std::vector<double> > orthogonalBasis = std::vector<std::vector<double> >(m_graph, std::vector<double>(m_graph + n_graph));
  std::vector<std::vector<double> > reducedBasis = lll(lattice, orthogonalBasis, m_graph, m_graph + n_graph);
  printBasis(reducedBasis, m_graph, m_graph + n_graph);
